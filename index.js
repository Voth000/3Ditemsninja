...
loader1.load('./6.glb', function(glb){
  console.log(glb);
...
const al = new THREE.AmbientLight(0xFee03ff, 0.1)
al.position.set(20,-10,-5)

scene.add( al )

const wl = new THREE.DirectionalLight(0x03ffee, 0.4)
